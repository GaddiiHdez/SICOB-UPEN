  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-box fade-in" onClick={e => e.stopPropagation()} style={{ maxWidth: 500 }}>
        ...
        {/* Resumen del equipo */}
        <div style={{ background: 'var(--bg-body)', border: '1px solid var(--border)', borderRadius: 'var(--radius-md)', padding: '12px 16px', marginTop: 12, fontSize: 12 }}>
        ...
        <form onSubmit={onSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16, marginTop: 16 }}>
          ...
          {mantenimiento.bien.id && (
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, background: 'rgba(13, 148, 136, 0.04)', border: '1px dashed rgba(13, 148, 136, 0.2)', padding: '10px 14px', borderRadius: 'var(--radius-md)' }}>
              ...
              <label htmlFor="reasignar" style={{ fontSize: 11, cursor: 'pointer', lineHeight: 1.3 }}>
